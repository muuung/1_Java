...
public class ArrayExample {
	...
	public void ex2() {
		...
		// 배열 초기화
		// 1) 인덱스를 이용한 초기화
		// arr int[] 참조형 변수가 참조하고 있는 배열의 0번 인덱스에 100을 대입
		arr[0] = 100;
		arr[1] = 200;
		arr[2] = 300;
		arr[3] = 400;
	...
	public void ex3() {
		...
		// 배열의 주소가 출력됨
		// 왜? arr 참조 변수에는 배열의 시작 주소가 저장되어 있기 때문
	...
	public void ex4() {
		// ArrayIndexOutBoundsException : 배열 인덱스 범위 초과
	...
	public void ex6() {
		...
		String[] menuArr = {"쌍쌍바", "죠스바", "메로나", "바밤바", "요맘때"};
	...
	public void ex7() {
		...
		// breakpoint를 지정한 줄 이전에 멈춤
		// for문에 break point를 지정하면 증감식이 해석되기 전에 멈춤(debug mode)
